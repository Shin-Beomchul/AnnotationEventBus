...
class TopLeftFmt : BaseFragment() {

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater!!.inflate(R.layout.fmt_top_left, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): TopLeftFmt {
            val fragment = TopLeftFmt()
            val args = Bundle()
